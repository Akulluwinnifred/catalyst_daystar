...
class BabySitter(models.Model):
    ...
    LevelOfEducation = models.CharField(max_length=200, null=True, blank=True)
    Contact = models.IntegerField(null=True, blank=True)
    SitterNumber = models.CharField(max_length=200,null=True, blank=True)
    NextOfKin = models.CharField(max_length=200, null=True, blank=True)
    RecommendersName = models.CharField(max_length=200, null=True, blank=True)
    RecommendersContact = models.IntegerField(null=True, blank=True)
